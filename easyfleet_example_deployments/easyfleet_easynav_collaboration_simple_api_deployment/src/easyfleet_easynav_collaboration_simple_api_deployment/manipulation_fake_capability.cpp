...
// See the matching comment in perception_fake_capability.cpp for why this
// is a non-template alias rather than registering
// easyfleet_core::CapabilityFactoryFor<ManipulationFakeActionServer> directly.
using ManipulationFakeCapabilityFactory =
  easyfleet_core::CapabilityFactoryFor<ManipulationFakeActionServer>;

}  // namespace easyfleet_easynav_collaboration_simple_api_deployment

PLUGINLIB_EXPORT_CLASS(
  easyfleet_easynav_collaboration_simple_api_deployment::ManipulationFakeCapabilityFactory,
