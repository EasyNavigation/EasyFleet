...
using easyfleet_easynav_collaboration_simple_api_deployment::PerceptionFakeCapability;
...
// src/EasyFleet/easyfleet_easynav_collaboration_simple_api_deployment), so tests
