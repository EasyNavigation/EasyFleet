...
#ifndef CONTROL_CENTER__CAPABILITY_INFO_HPP_
#define CONTROL_CENTER__CAPABILITY_INFO_HPP_
...
/// its `/capabilities` (arch_mockup_interfaces/CapabilityDescription) and
/// `/capabilities_status` (arch_mockup_interfaces/CapabilityStatus)
...
#endif  // CONTROL_CENTER__CAPABILITY_INFO_HPP_
