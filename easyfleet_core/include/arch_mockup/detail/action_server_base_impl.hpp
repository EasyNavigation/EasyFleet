...
#ifndef ARCH_MOCKUP__DETAIL__ACTION_SERVER_BASE_IMPL_HPP_
#define ARCH_MOCKUP__DETAIL__ACTION_SERVER_BASE_IMPL_HPP_

// Out-of-line member definitions for arch_mockup::ActionServerBase<ActionT>.
// Included from the bottom of arch_mockup/action_server_base.hpp. Not meant
// to be included directly: templates cannot be compiled into arch_mockup's
...
#endif  // ARCH_MOCKUP__DETAIL__ACTION_SERVER_BASE_IMPL_HPP_
