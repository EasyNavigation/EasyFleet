...
#ifndef EASYFLEET_CORE__MANIPULATION_ACTION_SERVER_BASE_HPP_
#define EASYFLEET_CORE__MANIPULATION_ACTION_SERVER_BASE_HPP_
...
/// action type itself.
class ManipulationActionServerBase
  : public ActionServerBase<easyfleet_interfaces::action::Manipulation>
{
public:
  using ActionServerBase<easyfleet_interfaces::action::Manipulation>::ActionServerBase;
};

}  // namespace easyfleet_core

#endif  // EASYFLEET_CORE__MANIPULATION_ACTION_SERVER_BASE_HPP_
